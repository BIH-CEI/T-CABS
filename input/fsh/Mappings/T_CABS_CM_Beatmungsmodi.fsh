...
* group[=].element[=].target[=].comment = "Unbewertet."
...
* group[=].element[=].target[=].comment = "Unbewertet. MPV (Mouthpiece Ventilation) not in IEEE 11073 — mapped to CMV-PC as closest match"
...
* group[=].element[=].target[=].equivalence = #wider
* group[=].element[=].target[=].comment = "Unbewertet. MPV not in IEEE 11073 — mapped to CMV-VC with adjuncts"
...
* group[=].element[=].target[=].equivalence = #wider
* group[=].element[=].target[=].comment = "Unbewertet. Adaptive mode — closest IEEE match is volume-targeted PS with Cycle Control"
...
* group[=].element[=].target[=].display = "MDC_VENT_MODE_ISO_AC_PC5vLim_6ACAPH_3LC_3TRGC"
* group[=].element[=].target[=].equivalence = #wider
* group[=].element[=].target[=].comment = "Unbewertet. Timed mode mapped to PCV as closest mandatory pressure-controlled mode"
...
* group[=].element[=].target[=].display = "MDC_VENT_MODE_ISO_AC_PC_6ACAP"
* group[=].element[=].target[=].equivalence = #wider
* group[=].element[=].target[=].comment = "Unbewertet. Adaptive PCV — closest standard AC-PC mode"
...
* group[=].element[=].target[=].display = "MDC_VENT_MODE_ISO_CSV_vtPS_3CC"
* group[=].element[=].target[=].equivalence = #wider
* group[=].element[=].target[=].comment = "Unbewertet. Adaptive mode with automatic pressure adjustment"
...
// =============================================================================
// Group 3: ResMed mode names (from AVX API "mode" field) → IEEE 11073
// =============================================================================
...
* group[=].element[=].target[=].display = "MDC_VENT_MODE_ISO_CSV_vtPS_3CC"
* group[=].element[=].target[=].equivalence = #equivalent
* group[=].element[=].target[=].comment = "Unbewertet. Volume-targeted Pressure Support with Cycle Control"
...
* group[=].element[=].target[=].display = "MDC_VENT_MODE_ISO_CSV_6ACAP"
* group[=].element[=].target[=].equivalence = #wider
* group[=].element[=].target[=].comment = "Unbewertet. AutoSet is auto-titrating CPAP — closest IEEE match is CPAP"
...
* group[=].element[=].target[=].display = "MDC_VENT_MODE_ISO_CSV_vtPS_3CC"
* group[=].element[=].target[=].equivalence = #wider
* group[=].element[=].target[=].comment = "Unbewertet. ASV is adaptive — closest IEEE match is volume-targeted PS with Cycle Control"
