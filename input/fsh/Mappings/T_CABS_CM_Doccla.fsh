...
* group[=].element[=].target[=].comment = "Doccla UniFHIR v2 verified. Panel code. Profile: https://bih-cei.github.io/T-CABS/StructureDefinition/t-cabs-observation-arteriellerblutdruck"
...
* group[=].element[=].target[=].equivalence = #equivalent
* group[=].element[=].target[=].comment = "Doccla UniFHIR v2 verified. Component, unit: mm[Hg]. Profile: https://bih-cei.github.io/T-CABS/StructureDefinition/t-cabs-observation-arteriellerblutdruck"
...
* group[=].element[=].target[=].equivalence = #equivalent
* group[=].element[=].target[=].comment = "Doccla UniFHIR v2 verified. SNOMED CT UK Extension. Component, unit: mm[Hg]. Profile: https://bih-cei.github.io/T-CABS/StructureDefinition/t-cabs-observation-arteriellerblutdruck"
...
* group[=].element[=].target[=].equivalence = #equivalent
* group[=].element[=].target[=].comment = "Unit: kg. Profile: https://bih-cei.github.io/T-CABS/StructureDefinition/t-cabs-observationhandgriffstaerke"
