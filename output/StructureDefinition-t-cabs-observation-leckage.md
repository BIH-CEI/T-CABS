...
| Draft as of 2025-11-25 | *Computable Name*:T_CABS_Observation_Leckage |
...
* Examples for this Profile: [Observation/Example-Leckage-ResMed](Observation-Example-Leckage-ResMed.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/t-cabs|current/StructureDefinition/t-cabs-observation-leckage)
...
Other representations of profile: [CSV](StructureDefinition-t-cabs-observation-leckage.csv), [Excel](StructureDefinition-t-cabs-observation-leckage.xlsx), [Schematron](StructureDefinition-t-cabs-observation-leckage.sch) 
