# Beispiel Channel ResMed Leckage - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Beispiel Channel ResMed Leckage**

## Example Device: Beispiel Channel ResMed Leckage
...
**parent**: [Device: identifier = http://tcabs.example.org/device-vmd#VMD-RESMED-LECKAGE-001; type = MDC_DEV_SYS_PT_VENT_VMD](Device-beispiel-vmd-resmed-leckage.md)
