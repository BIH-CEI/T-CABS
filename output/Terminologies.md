# Terminologies - T-CABS Implementation Guide v0.1.0
...
**Link**: [ValueSet Ventilation Form](ValueSet-t-cabs-valueset-Beatmungsform.md)
...
**Link**: [ValueSet Ventilation Mode](ValueSet-t-cabs-valueset-Beatmungsmodus.md)
...
**Link**: [ValueSet Ventilation Site](ValueSet-t-cabs-valueset-beatmungsstelle.md)
...
**Link**: [ValueSet PHD Type](ValueSet-t-cabs-valueset-phdtyp.md)
