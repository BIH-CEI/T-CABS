...
* **T-CABS Observation AHI**

## Resource Profile: T-CABS Observation AHI 

| | |
| :--- | :--- |
| *Official URL*:http://t-cabs.org/StructureDefinition/t-cabs-observation-ahi | *Version*:0.1.0 |
| Draft as of 2025-11-20 | *Computable Name*:T_CABS_Observation_AHI |
...
* Examples for this Profile: [Observation/Example-AHI-BREAS](Observation-Example-AHI-BREAS.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/t-cabs|current/StructureDefinition/t-cabs-observation-ahi)
...
Other representations of profile: [CSV](StructureDefinition-t-cabs-observation-ahi.csv), [Excel](StructureDefinition-t-cabs-observation-ahi.xlsx), [Schematron](StructureDefinition-t-cabs-observation-ahi.sch) 
