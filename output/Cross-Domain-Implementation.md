# Cross-Domain Implementation - T-CABS Implementation Guide v0.1.0
...
The T-CABS Patient profile extends the MII PR Person Patient Profile. Additionally, the profile is based on the preparatory work of the [International Patient Summary (IPS)](https://hl7.org/fhir/uv/ips/history.html) and aims for compatibility with the specifications of KBV and gematik.
