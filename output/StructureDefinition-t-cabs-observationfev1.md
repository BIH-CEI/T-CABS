...
* **T-CABS Observation FEV1**

## Resource Profile: T-CABS Observation FEV1 

| | |
| :--- | :--- |
| *Official URL*:http://t-cabs.org/StructureDefinition/t-cabs-observationfev1 | *Version*:0.1.0 |
| Draft as of 2025-11-20 | *Computable Name*:T_CABS_Observation_FEV1 |
...
* Examples for this Profile: [Observation/Example-FEV1-Doccla](Observation-Example-FEV1-Doccla.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/t-cabs|current/StructureDefinition/t-cabs-observationfev1)
...
Other representations of profile: [CSV](StructureDefinition-t-cabs-observationfev1.csv), [Excel](StructureDefinition-t-cabs-observationfev1.xlsx), [Schematron](StructureDefinition-t-cabs-observationfev1.sch) 
