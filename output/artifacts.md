...
| | |
| :--- | :--- |
| [T-CABS Logical Model](StructureDefinition-t-cabs-logical-model.md) | Comprehensive logical model for the T-CABS project covering:* Cross-domain entities (Patient, Organization)
...
| [T-CABS Device MDS Ventilator](StructureDefinition-t-cabs-device-mds-beatmungsgeraet.md) | Profile for a ventilator device |
