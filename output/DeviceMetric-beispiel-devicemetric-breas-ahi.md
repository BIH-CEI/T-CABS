# Beispiel DeviceMetric BREAS AHI - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Beispiel DeviceMetric BREAS AHI**

## Example DeviceMetric: Beispiel DeviceMetric BREAS AHI
...
**parent**: [Device: identifier = http://tcabs.example.org/device-channel#CHAN-BREAS-AHI-001; type = MDC_DEV_SYS_PT_VENT_CHAN](Device-beispiel-channel-breas-ahi.md)
